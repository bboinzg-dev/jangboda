...
function BenefitsGate({
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-stone-50 border border-stone-200 rounded-lg p-4 text-xs text-stone-500 leading-relaxed">
        <strong className="text-stone-700 block mb-1">왜 게이팅이 있나요?</strong>
