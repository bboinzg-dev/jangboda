  ...
  return (
    <div className="space-y-6">
      <header className="bg-gradient-to-br from-warning-soft to-warning-soft border border-warning/20 rounded-2xl p-6">
        <div className="text-2xs font-medium text-warning-text mb-1">
          부가기능 · 유료 API 사용
        </div>
        ...
        <p className="text-xs text-warning-text bg-surface/70 border border-warning/30 rounded-lg px-3 py-2 mt-3 leading-relaxed">
